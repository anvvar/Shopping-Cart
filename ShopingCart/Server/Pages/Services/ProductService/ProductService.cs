...
namespace ShopingCart.Server.Pages.Services.ProductService
{
    public class ProductService : IProductService
    {
        ...
        public async Task<List<Product>> GetProductsCategory(string categoryUrl)
        {
        ...
        public List<Product> Products { get; set; } = new List<Product> {
                ...
                new Product {
                    ...
                    Image = "https://upload.wikimedia.org/wikipedia/en/c/c4/Nineteen_Eighty_Four.jpg?20171121065805",
                    Price = 6.99m
                },
                new Product {
                    Id = 4,
